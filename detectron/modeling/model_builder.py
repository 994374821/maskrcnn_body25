...
import detectron.modeling.add_pose_fpn as add_pose_fpn
import detectron.modeling.mask_res_top as mask_res_top 
import detectron.modeling.mask_res_top_attention as mask_res_top_attention
...
def get_func(func_name):
    ...
    function in this module or the path to a function relatmask_res_top_attentionive to the base
    'modeling' module.
    """
    if func_name == '':
        return None
...
def build_generic_detection_model(
    ...
    def _single_gpu_build_func(model):
        ...
        # mask restop
        head_loss_gradients['res_seg_human'] = mask_res_top_attention.add_mask_res_branch(model, blob_conv, 256)
        ...
        # add FPN pose branch for shoes,legs
#        head_loss_gradients['box_pose'] = add_pose_fpn.add_pose_fpn_rcnn_head(model, blob_conv[:2], dim_conv, spatial_scale_conv)
...
#        head_loss_gradients['res_seg_human'] = mask_res_top.add_mask_res_branch(model, blob_conv, 256)
